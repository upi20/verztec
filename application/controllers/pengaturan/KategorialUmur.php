...
/**
 * Pengaturan - KategorialUmur
 * @author Soni Setiawan -> untuk semua function yang ada di class KategorialUmur
 */
class KategorialUmur extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master kategorial-umur
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Pengaturan', 'Kategorial Umur'];
        ...
        $this->breadcrumb_3 = 'Kategorial Umur';
        $this->breadcrumb_3_url = base_url() . 'pengaturan/kategorial-umur';

        // content
        $this->content      = 'pengaturan/kategorial-umur';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model pengaturan/kategorial-umur dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List KategorialUmur $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model pengaturan/kategorial-umur dan meng generate kedalam excel
     * @param order $order
    ...
    public function export_excel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setTitle($title_excel)
            ->setSubject("Administrator")
            ->setDescription("List Kategorial Umur $date")
            ->setKeywords("Laporan, Report")
            ->setCategory("Laporan, Report");
        // set default font
        $spreadsheet->getDefaultStyle()->getFont()->setName('Calibri');
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model pengaturan/kategorial-umur dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getKategorialUmur untuk mengambil data kategorial-umur dari model pengaturan/getKategorialUmur dan mengirim output json
     * @param id $id
     * @return data, code berupa json
     */
    public function getKategorialUmur()
    {
        $id = $this->input->get("id");
        $result = $this->model->getKategorialUmur($id);
        $code = $result ? 200 : 500;
    ...
    public function import_excel()
    {
        ...
        foreach ($array_from_excel as $val) {
            if ($num > 5 && $val[3]) {
                ...
                $tbh = $this->db->insert('kategorial-umur', [
    ...
    /**
     * Fungsi insert untuk menyimpan data kedalam model pengaturan/insert dan outpunya nya json
     * @param nama $nama
     * @param status $status
     * @return data, code
     */
    public function insert()
    {
        ...
        $result = $this->model->insert($nama, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    /**
     * Fungsi update untuk mengubah data kedalam model pengaturan/update dan outpunya nya json
     * @param id $id
     * @param nama $nama
     * @param status $status
     * @return data, code
    ...
    public function update()
    {
        ...
        $nama = $this->input->post("nama");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $nama, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    /**
     * Fungsi delete untuk menghapus data dari model pengaturan/delete dan outpunya nya json
     * @param id $id
     * @return data, code
     */
