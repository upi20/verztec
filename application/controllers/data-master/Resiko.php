...
/**
 * Data Master - Resiko
 * @author Soni Setiawan -> untuk semua function yang ada di class Resiko
 */
class Resiko extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master resiko
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Resiko'];
        ...
        $this->breadcrumb_3 = 'Resiko';
        $this->breadcrumb_3_url = base_url() . 'data-master/resiko';

        // content
        $this->content      = 'data-master/resiko';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model data-master/resiko dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Resiko $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model data-master/resiko dan meng generate kedalam excel
     * @param order $order
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model data-master/resiko dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getResiko untuk mengambil data resiko dari model data-master/getResiko dan mengirim output json
     * @param id $id
    ...
    public function getResiko()
    {
        ...
        $result = $this->model->getResiko($id);
        $code = $result ? 200 : 500;
    ...
    /**
     * Fungsi insert untuk menyimpan data kedalam model data-master/insert dan outpunya nya json
     * @param nama $nama
     * @param status $status
     * @return data, code
     */
    ...
    /**
     * Fungsi update untuk mengubah data kedalam model data-master/update dan outpunya nya json
     * @param id $id
     * @param nama $nama
     * @param status $status
     * @return data, code
    ...
    /**
     * Fungsi delete untuk menghapus data dari model data-master/delete dan outpunya nya json
     * @param id $id
     * @return data, code
     */
