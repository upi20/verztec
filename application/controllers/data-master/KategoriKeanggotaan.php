...
/**
 * Data Master - Kategori Keanggotaan
 * @author Soni Setiawan -> untuk semua function yang ada di class Kategori Keanggotaan
 */
class KategoriKeanggotaan extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master kategori keanggotaan
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Kategori Keanggotaan'];
        ...
        $this->breadcrumb_3 = 'Kategori Keanggotaan';
        $this->breadcrumb_3_url = base_url() . 'data-master/kategoriKeanggotaan';

        // content
        $this->content      = 'data-master/kategori-keanggotaan';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model data master/kategori keanggotaan dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Kategori Keanggotaan $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model partner/kategori keanggotaan dan meng generate kedalam excel
     * @param order $order
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model partner/kategori keanggotaan dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getKategoriKeanggotaan untuk mengambil data kategori keanggotaan dari model data-master/getKategoriKeanggotaan dan mengirim output json
     * @param id $id
    ...
    public function getKategoriKeanggotaan()
    {
        ...
        $result = $this->model->getKategoriKeanggotaan($id);
        $code = $result ? 200 : 500;
    ...
    function __construct()
    {
        ...
        // id dari menu data master kategori keanggotaan
        $this->id_menu = 128;
        $get_menu = $this->db->get_where('term_management', ['id_menu' => $this->id_menu])->row_array();
        $this->modul = $get_menu['nama'];

        $this->load->model("data-master/KategoriKeanggotaanModel", 'model');
