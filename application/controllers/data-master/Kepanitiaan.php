...
/**
 * Data Master - Kepanitiaan
 * @author Soni Setiawan -> untuk semua function yang ada di class Kepanitiaan
 */
class Kepanitiaan extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master kepanitiaan
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Kepanitiaan'];
        ...
        $this->breadcrumb_3 = 'Kepanitiaan';
        $this->breadcrumb_3_url = base_url() . 'data-master/kepanitiaan';

        // content
        $this->content      = 'data-master/kepanitiaan';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model data master/kepanitiaan dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Kepanitiaan $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model partner/kepanitiaan dan meng generate kedalam excel
     * @param order $order
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model partner/kepanitiaan dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getKepanitiaan untuk mengambil data kepanitiaan dari model data-master/getKepanitiaan dan mengirim output json
     * @param id $id
    ...
    public function getKepanitiaan()
    {
        ...
        $result = $this->model->getKepanitiaan($id);
        $code = $result ? 200 : 500;
