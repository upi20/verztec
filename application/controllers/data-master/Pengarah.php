...
/**
 * Data Master - Pengarah
 * @author Soni Setiawan -> untuk semua function yang ada di class Pengarah
 */
class Pengarah extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master pengarah
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Pengarah'];
        ...
        $this->breadcrumb_3 = 'Pengarah';
        $this->breadcrumb_3_url = base_url() . 'data-master/pengarah';

        // content
        $this->content      = 'data-master/pengarah';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model data master/pengarah dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Pengarah $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model partner/pengarah dan meng generate kedalam excel
     * @param order $order
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model partner/pengarah dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getPengarah untuk mengambil data pengarah dari model data-master/getPengarah dan mengirim output json
     * @param id $id
     * @return data, code berupa json
     */
    public function getPengarah()
    {
        $id = $this->input->get("id");
        $result = $this->model->getPengarah($id);
        $code = $result ? 200 : 500;
