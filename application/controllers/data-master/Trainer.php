...
class Trainer extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Trainer'];
        ...
        $this->breadcrumb_3 = 'Trainer';
        $this->breadcrumb_3_url = base_url() . 'data-master/trainer';

        // content
        $this->content      = 'data-master/trainer';
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Trainer $date")
    ...
    public function getTrainer()
    {
        ...
        $result = $this->model->getTrainer($id);
        $code = $result ? 200 : 500;
    ...
    public function import_excel()
    {
        ...
        foreach ($array_from_excel as $val) {
            if ($num > 5 && $val[3]) {
                ...
                $id_profile = 0;
                $status = $status_id;
                $tbh = $this->model->insert($nama, $id_profile, $status);
            }
            $num++;
        }
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($nama, $id_profile, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function update()
    {
        ...
        $id_profile = $this->input->post("id_profile");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $nama, $id_profile, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/TrainerModel", 'model');
