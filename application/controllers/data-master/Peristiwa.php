...
class peristiwa extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Data Formal'];
        ...
        $this->breadcrumb_3 = 'Peristiwa';
        $this->breadcrumb_3_url = base_url() . 'data-master/peristiwa';

        // content
        $this->content      = 'data-master/peristiwa/list';
    ...
    public function export_excel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Peristiwa $date")
        ...
        foreach ($details as $detail) {
            ...
            $sheet->setCellValue(chr(65 + ++$c) . "$row", $detail['details']);
    ...
    public function export_pdf()
    {
        ...
        foreach ($details as $i => $detail) {
            ...
            $body_table .= "<td>{$detail['name']}</td>";
            $body_table .= "<td>{$detail['details']}</td>";
    ...
    public function downloadSample()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Peristiwa_Sample";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
    ...
    public function import_excel()
    {
        ...
        foreach ($array_from_excel as $val) {
            if ($num > 5 && $val[4]) {
                ...
                $tbh = $this->db->insert('dtm_peristiwa', [
                    "name"   => $val[1] == "" ? NULL : $val[1],
                    "details"   => $val[2] == "" ? NULL : $val[2],
                    "status"         => $status_id,
                    "created_at"    => date("Y-m-d H:i:s")
                ]);
            }
    ...
    public function insert()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $result = $this->model->insert($name, $kategori, $details, $status);
    ...
    public function update()
    {
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('id', 'id Peristiwa', 'trim|required|numeric');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $details = $this->input->post('details');
            $status = $this->input->post('status');
            $result = $this->model->update($id, $name, $kategori, $details, $status);
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/peristiwaModel", 'model');
