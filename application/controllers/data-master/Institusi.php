...
class Institusi extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Institusi'];
        ...
        $this->breadcrumb_3 = 'Institusi';
        $this->breadcrumb_3_url = base_url() . 'data-master/institusi';

        // content
        $this->content      = 'data-master/institusi';
    ...
    public function export_excel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Institusi $date")
    ...
    public function downloadSample()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Institusi_Sample";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
    ...
    public function update()
    {
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('id', 'id Institusi', 'trim|required|numeric');
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/InstitusiModel", 'model');
