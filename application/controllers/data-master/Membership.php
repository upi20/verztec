...
class Membership extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Membership'];
        ...
        $this->breadcrumb_3 = 'Membership';
        $this->breadcrumb_3_url = base_url() . 'data-master/membership';

        // content
        $this->content      = 'data-master/membership';
    ...
    public function export_excel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Membership $date")
    ...
    public function downloadSample()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Membership_Sample";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
    ...
    public function import_excel()
    {
        ...
        foreach ($array_from_excel as $val) {
            if ($num > 5 && $val[4]) {
                ...
                $tbh = $this->db->insert('jenis_membership', [
    ...
    public function getMembership()
    {
        ...
        $result = $this->model->getMembership($id);
        $code = $result ? 200 : 500;
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/MembershipModel", 'model');
