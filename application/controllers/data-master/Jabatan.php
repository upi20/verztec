...
/**
 * Data Master - Jabatan
 * @author Soni Setiawan -> untuk semua function yang ada di class Jabatan
 */
class Jabatan extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master jabatan
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Jabatan'];
        ...
        $this->breadcrumb_3_url = base_url() . 'data-master/jabatan';

        // content
        $this->content      = 'data-master/jabatan';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model data master/jabatan dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Jabatan $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model partner/jabatan dan meng generate kedalam excel
     * @param order $order
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model partner/jabatan dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getJabatan untuk mengambil data jabatan dari model data-master/getJabatan dan mengirim output json
     * @param id $id
    ...
    public function getJabatan()
    {
        ...
        $result = $this->model->getJabatan($id);
        $code = $result ? 200 : 500;
