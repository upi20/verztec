...
class Kode extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Kode'];
        ...
        $this->breadcrumb_3 = 'Kode';
        $this->breadcrumb_3_url = base_url() . 'data-master/kode';

        // content
        $this->content      = 'data-master/kode';
    ...
    public function downloadSample()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Kode_Sample";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
    ...
    public function getKode()
    {
        ...
        $result = $this->model->getKode($id, $id_menu);
        $code = $result ? 200 : 500;
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($id_menu, $id_kategori, $kode, $bulan, $tahun, $jumlah, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function update()
    {
        ...
        $jumlah = $this->input->post("jumlah");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $id_menu, $id_kategori, $kode, $bulan, $tahun, $jumlah, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function ajax_select_list_kategori_anggota()
    {
        $id_menu = $this->input->post('id_menu');
        $return = $this->model->list_kategori_anggota($id_menu);
        $this->output_json($return);
    }
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/KodeModel", 'model');
