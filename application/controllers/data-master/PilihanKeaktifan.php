...
/**
 * Data Master - PilihanKeaktifan
 * @author Soni Setiawan -> untuk semua function yang ada di class PilihanKeaktifan
 */
class PilihanKeaktifan extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master pilihanKeaktifan
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Pilihan Keaktifan'];
        ...
        $this->breadcrumb_3 = 'Pilihan Keaktifan';
        $this->breadcrumb_3_url = base_url() . 'data-master/pilihanKeaktifan';

        // content
        $this->content      = 'data-master/pilihan-keaktifan';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model data master/pilihanKeaktifan dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Pilihan Keaktifan $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model partner/pilihanKeaktifan dan meng generate kedalam excel
     * @param order $order
    ...
    public function export_excel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setTitle($title_excel)
            ->setSubject("Administrator")
            ->setDescription("List PilihanKeaktifan $date")
            ->setKeywords("Laporan, Report")
            ->setCategory("Laporan, Report");
        // set default font
        $spreadsheet->getDefaultStyle()->getFont()->setName('Calibri');
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model partner/pilihanKeaktifan dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getPilihanKeaktifan untuk mengambil data pilihanKeaktifan dari model data-master/getPilihanKeaktifan dan mengirim output json
     * @param id $id
     * @return data, code berupa json
     */
    public function getPilihanKeaktifan()
    {
        $id = $this->input->get("id");
        $result = $this->model->getPilihanKeaktifan($id);
        $code = $result ? 200 : 500;
    ...
    function __construct()
    {
        ...
        // id dari menu data master Pilihan Keaktifan
        $this->id_menu = 139;
        $get_menu = $this->db->get_where('term_management', ['id_menu' => $this->id_menu])->row_array();
        $this->modul = $get_menu['nama'];

        $this->load->model("data-master/pilihanKeaktifanModel", 'model');
