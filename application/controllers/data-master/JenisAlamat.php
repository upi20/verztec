...
class JenisAlamat extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Jenis Alamat'];
        ...
        $this->breadcrumb_3 = 'Jenis Alamat';
        $this->breadcrumb_3_url = base_url() . 'data-master/jenis-alamat';

        // content
        $this->content      = 'data-master/jenis-alamat';
    ...
    public function export_excel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Jenis Alamat $date")
    ...
    public function update()
    {
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('id', 'id Jenis Alamat', 'trim|required|numeric');
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/jenisAlamatModel", 'model');
