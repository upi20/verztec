...
class JenisGelar extends Render_Controller
{
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Jenis Gelar'];
        ...
        $this->breadcrumb_3 = 'Jenis Gelar';
        $this->breadcrumb_3_url = base_url() . 'data-master/jenis-gelar';

        // content
        $this->content      = 'data-master/jenis-gelar';
    ...
    public function export_excel()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Jenis Gelar $date")
    ...
    public function downloadSample()
    {
        ...
        $col_start = "A";
        $col_end = "E";
        $title_excel = "AuditAny_Data_Master_Jenis_Gelar_Sample";
        // Header excel ================================================================================================
        $spreadsheet = new PhpOffice\PhpSpreadsheet\Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
    ...
    public function import_excel()
    {
        ...
        foreach ($array_from_excel as $val) {
            if ($num > 5 && $val[4]) {
                ...
                $tbh = $this->db->insert('jenis_gelar', [
    ...
    public function update()
    {
        $this->load->library('form_validation');
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('id', 'id Jenis Gelar', 'trim|required|numeric');
    ...
    function __construct()
    {
        ...
        $this->load->model("data-master/jenisGelarModel", 'model');
