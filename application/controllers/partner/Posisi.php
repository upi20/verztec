...
/**
 * Partner - Posisi
 * @author Soni Setiawan -> untuk semua function yang ada di class Posisi
 */
class Posisi extends Render_Controller
{
    /**
     * Fungsi index untuk menampilkan tampilan data master posisi
     */
    public function index()
    {
        // Page Settings
        $this->title = $this->getMenuTitle();
        $this->navigation = ['Data Master', 'Posisi'];
        $this->plugins = ['datatables', 'moment'];

        // Breadcrumb setting
        $this->breadcrumb_1 = 'Dashboard';
        $this->breadcrumb_1_url = base_url();
        $this->breadcrumb_2 = 'Partner';
        $this->breadcrumb_2_url = '#';
        $this->breadcrumb_3 = 'Posisi';
        $this->breadcrumb_3_url = base_url() . 'partner/posisi';

        // content
        $this->content      = 'partner/posisi';
    ...
    /**
     * Fungsi ajax_data untuk mengambil data dari model partner/posisi dan mengirim data output nya json
     * @param order $order
     * @param start $start
     * @param draw $draw
     * @param length $length
    ...
    public function downloadSample()
    {
        ...
        $spreadsheet->getProperties()
            ...
            ->setDescription("List Posisi $date")
    ...
    /**
     * Fungsi export_excel untuk mengambil data dari model partner/posisi dan meng generate kedalam excel
     * @param order $order
    ...
    /**
     * Fungsi export_pdf untuk mengambil data dari model partner/posisi dan meng generate kedalam pdf
     * @param order $order
     * @param columns $columns
     * @param draw $draw
     * @return file pdf
    ...
    /**
     * Fungsi getPosisi untuk mengambil data posisi dari model partner/getPosisi dan mengirim output json
     * @param id $id
    ...
    public function getPosisi()
    {
        ...
        $result = $this->model->getPosisi($id);
        $code = $result ? 200 : 500;
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($nama, $no_urut, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function update()
    {
        ...
        $no_urut = $this->input->post("no_urut");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $nama, $no_urut, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
