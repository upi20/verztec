...
class Master extends Render_Controller
{
    public function index()
    {
        ...
        $this->breadcrumb_2 = 'Activity';
        $this->breadcrumb_2_url = '#';
        $this->breadcrumb_3 = $this->getMenuTitle();
        $this->breadcrumb_3_url = base_url() . 'activity/master/list';

        // content
        $this->content      = 'activity/master/list';
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($nama, $keterangan, $tanggal, $tempat, $status);
        $code = $result ? 200 : 500;
    ...
    public function update()
    {
        ...
        $tempat = $this->input->post("tempat");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $nama, $keterangan, $tanggal, $tempat, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    public function downloadSample()
    {
        ...
        foreach ($details as $detail) {
            ...
            $sheet->setCellValue(chr(65 + ++$c) . "$row", date("d-m-Y", strtotime($detail['tanggal'])));
    ...
    public function export_pdf()
    {
        ...
        foreach ($details as $i => $detail) {
            ...
            $body_table .= "<td>" . date("d-m-Y", strtotime($detail['tanggal'])) . "</td>";
            $body_table .= "<td>{$detail['tempat']}</td>";
            $body_table .= '</tr>';
        }
    ...
    public function import_excel()
    {
        ...
        foreach ($array_from_excel as $val) {
            if ($num > 5 && $val[2]) {
                ...
                $tanggal = $val[3] == "" ? NULL : $val[3];
                $tanggal = date("Y-m-d", strtotime($tanggal));
                $tempat = $val[4] == "" ? NULL : $val[4];
                $status = 1;

                $tbh = $this->model->insert($nama, $keterangan, $tanggal, $tempat, $status);
            }
            $num++;
        }
