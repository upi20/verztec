...
$(function () {
  ...
  if(filter == null){
    ...
    $("#jenis-peristiwa").val(filter).trigger('change')
  }
  let jenis = $("#jenis-peristiwa").val()
  ...
  function dynamic(){
    ...
    table_html.DataTable({
      "ajax": {
        "url": "<?= base_url()?>dashboard/getReportDataFormal/",
      ...
      "columns": [
        ...
        { "data": "peristiwa" },
        {
            "data": "tanggal_data_formal", render(data, type, full, meta) {
                ...
                return moment(data == null || data == '' ? full.tanggal_data_formal : full.tanggal_data_formal, 'YYYY-MM-DD H:mm:ss').format('DD-MM-YYYY');
