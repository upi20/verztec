...
<div class="row">
    <div class="col-12 col-sm-12 col-md-3">
       <div class="list-group">
          ...
          <a href="<?=base_url()?>dashboard/reportStatistikKeanggotaan" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action active">Detail Statistik <?=$kategori_keanggotaan_alias?> <span class="badge badge-primary badge-pill"><?=$totalStatistikKeanggotaan?></span></a>
            ...
            <div class="card-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" id="jenis-keanggotaan">
                                <option value="">*Pilih Keanggotaan</option>
                                <?php foreach($keanggotaan as $q):?>
                                    <option value="<?=$q['id']?>"><?=$q['keterangan']?> (<?=$q['nama']?>)</option>
                                <?php endforeach;?>
                                <option value="99999">Menunggu Konfirmasi</option>
                            </select>
                        </div>
                        <div class="col-md-3">
