...
<div class="row">
    <div class="col-12 col-sm-12 col-md-3">
       <div class="list-group">
          ...
          <a href="<?=base_url()?>dashboard/reportStatistikKeaktifan" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action active">Detail Statistik Keaktifan <span class="badge badge-primary badge-pill"><?=$totalStatistikKeaktifan?></span></a>
            ...
            <div class="card-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" id="jenis-keaktifan">
                                <option value="">*<?=$pilihan_keaktifan_alias?></option>
