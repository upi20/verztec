...
<div class="row">
    <div class="col-12 col-sm-12 col-md-3">
       <div class="list-group">
          ...
          <a href="<?=base_url()?>dashboard/reportStatistikKategorial" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action active">Detail Statistik <?=$kategorial_alias?> <span class="badge badge-primary badge-pill"><?=$totalStatistikKategorial?></span></a>
            ...
            <div class="card-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" id="jenis-kategorial">
