...
<div class="row">
    <div class="col-12 col-sm-12 col-md-3">
       <div class="list-group">
          ...
          <a href="<?=base_url()?>dashboard/reportStatistikDataFormal" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action active">Detail Statistik Data Formal <span class="badge badge-primary badge-pill"><?=$totalStatistikDataFormal?></span></a>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" id="jenis-peristiwa">
                                <option value="">*Pilih Peristiwa</option>
                                <?php foreach($peristiwa as $q):?>
