        ...
        <form id="form" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add New Music</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="titile" name="titile" placeholder="Music Title" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="singer">Signer</label>
                                <input type="text" class="form-control" id="singer" name="singer" placeholder="Signer" required />
                            </div>
                        </div>
                    </div>
