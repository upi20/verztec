    ...
    <div class="col-md-2 col-sm-6 col-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Total Podcast</span>
        ...
        <form id="form" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add New Podcast</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="titile" name="titile" placeholder="Podcast Title" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="speaker">Speaker</label>
                                <input type="text" class="form-control" id="speaker" name="speaker" placeholder="Podcast Speaker" required />
                            </div>
                        </div>
                    </div>
