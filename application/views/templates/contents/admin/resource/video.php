            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="nowarp text-right"><?= $d->duration ?></td>
                        <td class="nowrap">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="titile" name="titile" placeholder="Video Title" required />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="category" class="form-control select2" value="" style="width: 100%;" aria-placeholder="Select Tag">
                                    <option value="">Select Category</option>
                                    <option value="">Religion</option>
                                    <option value="">Education</option>
                                    <option value="">Journey</option>
