<div class="card">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" required value="<?= $profile['nik'] ?>" readonly/>
          </div>
        </div>
        <div class="col-md-2">
          <div class="form-group">
            <label for="nik">Keanggotaan</label>
            <input type="text" class="form-control" id="nik" required value="<?= $profile['keanggotaan'] ?>" readonly/>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_depan" name="nama_depan" placeholder="Nama Depan" required value="<?= $profile['nama_depan'] ?>" <?php if($profile['nama_depan'] != "") echo "readonly"; ?>/>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_belakang" name="nama_belakang" placeholder="Nama Belakang" value="<?= $profile['nama_belakang'] ?>" <?php if($profile['nama_belakang'] != "") echo "readonly"; ?> />
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="jk">Jenis Kelamin</label>
              ...
              <input type="text" class="form-control" name="jkjk" value="<?php if($profile['jenis_kelamin'] == 1) echo "Laki-laki"; else echo "Perempuan" ?>" readonly/>
              <?php else:?>
        ...
        <div class="col-md-6">
          ...
          <?php else:?>
            <input type="file" class="form-control" id="photo" name="photo" placeholder="Photo" ? style="display: none;">
            <br>
            <img src="<?=base_url()?>files/profile/<?=$profile['photo']?>" style="width: 50%;">
          <?php endif;?>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control" id="id_partner" name="id_partner" disabled>
              <option value="">Pilih Partner</option>
              <?php foreach ($partner as $p) : ?>
                <option value="<?= $p['id'] ?>" <?= $profile['id_partner'] == $p['id'] ? 'selected' : '' ?>><?= $p['text'] ?></option>
              <?php endforeach; ?>
            </select>
            <input type="hidden" name="id_partner" id="id_partner" value="<?= $profile['id_partner'] ?>">
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control" id="id_level" name="id_level" disabled>
            ...
            <input type="hidden" name="id_level" id="id_level" value="<?= $profile['lev_id'] ?>">
          </div>
        </div>
  ...
  <div class="card-footer text-right">
    ...
    <a class="btn btn-danger" href="<?= base_url() ?>pengaturan/password">Ubah Password?</a>
  </div>
</div>
          ...
          <div class="row" style="display: none;">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <select class="form-control" id="statusk" name="statusk">
