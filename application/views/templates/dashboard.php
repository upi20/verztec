...
<head>
	...
	<!-- icon -->
	<link rel="apple-touch-icon" sizes="57x57" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="60x60" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="72x72" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="76x76" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="114x114" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="120x120" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="144x144" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="152x152" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="apple-touch-icon" sizes="180x180" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="icon" type="image/png" sizes="192x192" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="icon" type="image/png" sizes="96x96" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	<link rel="manifest" href="<?= base_url() ?>assets/favicon/manifest.json">
	<meta name="msapplication-TileColor" content="#fff">
	<meta name="theme-color" content="#343a40">
	<meta name="msapplication-TileImage" content="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['favicon'] ?>">
	...
	<div class="wrapper">
		...
		<nav class="<?= $page_nav ?>" id="nav-top">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
					<a class="nav-link" data-toggle="dropdown" href="#" onclick="klikNotifikasi()" title="Notifikasi">
						<i class="far fa-bell"></i>
						<span class="badge badge-warning navbar-badge" id="jumlah-head-notifikasi">0</span>
					</a>
				...
				<li class="nav-item">
					...
					<label class="nav-link" for="dark-mode-switch" id="dark-mode-switch-label" style="cursor: pointer;" title="Tema Aplikasi">
						<i class="far fa-moon"></i>
					</label>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-widget="fullscreen" href="#" role="button" title="Tampilan Penuh">
						<i class="fas fa-expand-arrows-alt"></i>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url() ?>pengaturan/profile/lihat" title="Profil Saya">
						<i class="far fa-user"></i>
					</a>
				</li>
				<li class="nav-item">
					<button type="button" class="btn nav-link btn-logout" title="Keluar aplikasi?">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<?= base_url() ?>" class="brand-link">
				<img src="<?= base_url() ?>files/utilities/application-setting/<?= $detail_aplikasi['logo'] ?>" alt="<?= $detail_aplikasi['nama_aplikasi'] ?>" class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light"><?= $detail_aplikasi['nama_aplikasi'] ?></span>
			</a>
